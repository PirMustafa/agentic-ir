...
full-system configurations are complete on both datasets, all three ablations
are complete on HotpotQA, and on 2WikiMultihopQA \texttt{agentic\_no\_verifier}
and \texttt{agentic\_no\_planner} are complete and
\texttt{agentic\_no\_kg} was in flight. Two of the three components are
therefore measured twice, and both second measurements changed the reading:
the verifier's HotpotQA gain vanished, and the planner's HotpotQA null became
a significant twelve-point improvement from deleting it. That is why the
graph's single null is not treated here as settled either.
...
be doing measurable damage. The graph has not yet had its second measurement,
and on this evidence a second measurement is not a formality.
